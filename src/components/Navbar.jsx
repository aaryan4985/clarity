...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: "Get Started", link: "/signup", type: "route" },
  ];
            ...
            {navItems.map((item, index) => (
              ...
              >
                <a
                  href={item.link}
                  onClick={(e) => handleNavClick(e, item)}
                  className="block text-gray-700 font-medium hover:text-purple-600 px-4 py-3 rounded-lg transition-all duration-300"
                >
                  {item.name}
                </a>
              </li>
